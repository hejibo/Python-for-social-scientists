...
# -*- coding: utf-8 -*-
"""
This experiment was created using PsychoPy2 Experiment Builder (v1.79.01), March 03, 2016, at 09:31
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\fg30\\Downloads\\stroop\\stroop-example.psyexp',
...
instructinosComponents = []
instructinosComponents.append(instrText)
instructinosComponents.append(key_resp_2)
...
trials = data.TrialHandler(nReps=5, method='random', 
    extraInfo=expInfo, originPath='C:\\Users\\fg30\\Downloads\\stroop\\stroop-example.psyexp',
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if target.status == STARTED and t >= (0.5 + (4-win.monitorFramePeriod*0.75)): #most of one frame period left
    ...
    if response.keys in ['', [], None]:  # No response was made
       ...
       if str(corAns).lower() == 'none': response.corr = 1  # correct non-response
